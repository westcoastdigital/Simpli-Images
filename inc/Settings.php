...
class Simpli_Images_Settings
{
    ...
    public function register_settings()
    {
        ...
        register_setting('simpli_images_sizes', 'simpli_images_override_wp_functions', array(
            'type' => 'boolean',
            'sanitize_callback' => 'rest_sanitize_boolean',
            'default' => true
        ));
...
?>
    ...
    private function display_admin_messages()
    {
        ...
        if (isset($_GET['cache-cleared'])) {
            ...
            add_settings_error(
                'simpli_images_messages',
                'simpli_images_cache_message',
                sprintf('Cache cleared! %d cached images deleted.', $deleted),
                'updated'
            );
        }
        ...
        if (isset($_GET['thumbnails-regenerated'])) {
            ...
            add_settings_error(
                'simpli_images_messages',
                'simpli_images_regen_message',
                sprintf('Thumbnails regenerated for %d images.', $count),
                'updated'
            );
        }
        ...
        if (isset($_GET['thumbnails-error'])) {
            add_settings_error(
                'simpli_images_messages',
                'simpli_images_regen_error',
                'Error regenerating thumbnails. Please try again.',
                'error'
            );
        }
    ...
    ?>
        <form id="simpli-sizes-form">
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row">
                        <label for="simpli_images_override_wp_functions">
                            Override WordPress Image Functions
                        </label>
                    </th>
                    <td>
                        <label>
                            <input type="checkbox"
                                name="simpli_images_override_wp_functions"
                                id="simpli_images_override_wp_functions"
                                value="1"
                                <?php checked(get_option('simpli_images_override_wp_functions', true)); ?>>
                            Use Simpli Images for all WordPress image requests
                        </label>
                        <p class="description">
                            When enabled, functions like <code>wp_get_attachment_image()</code> and <code>the_post_thumbnail()</code>
                            will use dynamically generated optimized images instead of pre-generated thumbnails.
                        </p>
                    </td>
                </tr>
                <tr>
...
<?php
    ...
    public function ajax_save_sizes()
    {
        ...
        $disabled_sizes = isset($_POST['disabled_sizes']) && is_array($_POST['disabled_sizes'])
            ...
            : array();
        $override_wp_functions = isset($_POST['override_wp_functions']) && $_POST['override_wp_functions'] === '1';
        ...
        update_option('simpli_images_override_wp_functions', $override_wp_functions);
        ...
        wp_send_json_success(array(
            ...
            'settings' => array(
                ...
                'override_wp_functions' => $override_wp_functions,
